...
int idy=ng%Ndy;//0:dy8/dy2 1:dy5/dy2 2:dy8/dy5
int ibar=((int)(ng/Ndy))%Nbar;
int iside=((int)(ng/Nbar/Ndy))%Nside;
int ilayer=(int)(ng/Nside/Nbar/Ndy);
cout<<ng<<" "<<idy<<" "<<ibar<<" "<<iside<<" "<<ilayer<<endl; 
char cc[40];
...
EMC_DyRel[ng]=new TH2F(cc,cc,500,0,500,500,0,16500);
cout<<ng<<" "<<idy<<" "<<ibar<<" "<<iside<<" "<<ilayer<<endl; 
}
